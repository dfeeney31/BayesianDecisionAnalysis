...
### sample from Gaussian distribution with mean mu and sigma samples 
```{r echo = TRUE}
...
mu <- link( polymod , data=pred_dat ) #generate posterior distributions for the range of weights defined above
mu.mean <- apply( mu , 2 , mean )
